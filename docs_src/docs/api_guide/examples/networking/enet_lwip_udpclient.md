# Enet Lwip UDP Client Example{#EXAMPLES_ENET_LWIP_CPSW_UDPCLIENT}
...
This example shows about how to implement a simple UDP Client on LwIP networking stack using BSD-Socket API coupled with ethernet driver (ENET)
...
- Initializes the LwIP stack for TCP/UDP IP and Starts UDP Socket Client task.
