...
const includes = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/drivers/i2c/am261x-evm",
    ],
};
...
const libs_m4f = {
    common: [
        "nortos.am261x.m4f.ti-arm-clang.${ConfigName}.lib",
        "drivers.am261x.m4f.ti-arm-clang.${ConfigName}.lib",
        "unity.am261x.m4f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
[
    {
        input: ".project/templates/am261x/common/linker_m4f.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: ".project/templates/am261x/nortos/main_nortos.c.xdt",
...
function getComponentProperty() {
    ...
    property.name = "test_mpu_firewall";
