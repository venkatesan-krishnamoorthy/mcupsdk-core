...
const filedirs = {
    common: [
        ...
        "../../..", /* Example base */
        "../../../../../dpl", /* SDL DPL base */
		"../../../../../parity/sdl_tcmparity_functest/am261x-som",
    ],
};
...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/test/sdl/parity/sdl_tcmparity_functest/am261x-som/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_tcmparity_functest";
    property.isInternal = true;
    property.skipProjectSpec = true;
	property.description = "This test verifies error inject operations for TCM Parity"
