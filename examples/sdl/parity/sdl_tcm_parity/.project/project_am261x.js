...
const filedirs = {
    common: [
        ...
        "../../..", /* Example base */
        "../../../../../dpl", /* SDL DPL base */
		"../../../../../parity/sdl_tcm_parity/am261x-som",
    ],
};
...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/parity/sdl_tcm_parity/",
		"${MCU_PLUS_SDK_PATH}/examples/sdl/parity/sdl_tcm_parity/am261x-som/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_tcm_parity";
    property.isInternal = false;
	property.description = "This example verifies error inject operations for TCM Parity"
