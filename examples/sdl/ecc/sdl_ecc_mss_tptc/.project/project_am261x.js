...
const filedirs = {
    common: [
        ...
        "../../..", /* Example base */
        "../../../../../dpl", /* SDL DPL base */
		"../../../../../ecc/sdl_ecc_mss_tptc/am261x-som/",
    ],
};
...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_mss_tptc/",
	    "${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_mss_tptc/am261x-som/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_ecc_mss_tptc";
    property.isInternal = false;
	property.description = "This example verifies ECC inject operations in single and double bits for TPTC"
