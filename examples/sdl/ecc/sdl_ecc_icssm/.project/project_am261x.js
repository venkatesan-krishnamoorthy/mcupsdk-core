...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_icssm/",
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_icssm/am261x-som/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_ecc_icssm";
    property.isInternal = false;
	property.description = "This example verifies ECC inject operations in single and double bits for ICSSM"
