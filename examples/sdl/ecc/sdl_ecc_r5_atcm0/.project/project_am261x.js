...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_r5_atcm0/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_ecc_r5_atcm0";
    property.isInternal = false;
	property.description = "This example verifies ECC inject operations in single and double bits for R5FA ATCM0"
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/r5fss0-0/)) {
        build_property.defines = r5f0_0_macro;
    }

    if(buildOption.cpu.match(/r5fss0-1/)) {
        build_property.defines = r5f0_1_macro;
    }
