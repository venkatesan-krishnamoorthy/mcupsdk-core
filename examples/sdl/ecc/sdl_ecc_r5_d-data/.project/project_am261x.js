...
const filedirs = {
    common: [
        ...
        "../../..", /* Example base */
        "../../../../../dpl", /* SDL DPL base */
		"../../../../../ecc/sdl_ecc_r5_d-data/am261x-som",
    ],
};
...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_r5_d-data/am261x-som/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_ecc_r5_d-data";
    property.isInternal = false;
	property.description = "This example verifies ECC inject operations in single and double bits for R5F d-data"
