...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_OSPI_NAND_FLASH_IO";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ospi_nand_flash_io_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "ospi_nand_flash_io";
