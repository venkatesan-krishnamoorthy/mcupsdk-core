...
const files = {
    common: [
        "canfd_loopback_interrupt_std_exd.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_CANFD_LOOPBACK_INTERRUPT_STANDARD_EXTENDED_EXAMPLE";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "canfd_loopback_interrupt_std_exd_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "canfd_loopback_interrupt_std_exd";
