...
[
    {
        input: ".project/templates/am263px/sbl/sbl_ospi/main.c.xdt",
        output: "../main.c",
        options: template_options_cc
    },
    {
        input: ".project/templates/am263px/sbl/sbl_ospi/am263px-cc/board.c.xdt",
        output: "../board.c",
        options: template_options_cc
    }
];
...
[
    ...
    {
        input: ".project/templates/am263px/sbl/sbl_ospi/am263px-lp/board.c.xdt",
        output: "../board.c",
        options: template_options_lp
    }
];
