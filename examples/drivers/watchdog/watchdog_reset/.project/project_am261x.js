...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_WATCHDOG_RESET_MODE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "watchdog_reset_mode_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "watchdog_reset_mode";
    property.isInternal = false;
    property.description = "A Watchdog reset mode example. This example triggers the SOC warm reset."
