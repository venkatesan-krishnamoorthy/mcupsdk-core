...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_LIN_COMMANDER_WRITE_HLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "lin_commander_write_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "lin_commander_write";
