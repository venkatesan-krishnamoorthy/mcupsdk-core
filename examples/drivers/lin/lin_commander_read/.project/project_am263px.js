...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_LIN_COMMANDER_READ_HLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "lin_commander_read_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "lin_commander_read";
