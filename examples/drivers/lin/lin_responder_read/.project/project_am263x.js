...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_LIN_RESPONDER_READ_HLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "lin_responder_read_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "lin_responder_read";
