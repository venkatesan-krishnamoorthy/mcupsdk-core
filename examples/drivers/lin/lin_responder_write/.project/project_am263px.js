...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_LIN_RESPONDER_WRITE_HLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "lin_responder_write_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "lin_responder_write";
