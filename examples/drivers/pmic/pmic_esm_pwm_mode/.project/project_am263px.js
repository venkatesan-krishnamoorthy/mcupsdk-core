...
const readmeDoxygenPageTag = "EXAMPLES_PMIC_ESM_PWM_MODE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "pmic_esm_pwm_mode_main",
        },
    },
];
...
function getComponentProperty() {
    ...
    property.name = "pmic_esm_pwm_mode";
    property.isInternal = false;
    property.description = "An example to show PMIC ESM operation in pwm mode set interrupt and reset when error is detected in PWM signal on pmic esm_in pin"
