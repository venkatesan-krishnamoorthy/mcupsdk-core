...
const readmeDoxygenPageTag = "EXAMPLES_PMIC_ESM_LEVEL_MODE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "pmic_esm_level_mode_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "pmic_esm_level_mode";
    property.isInternal = false;
    property.description = "An example to show PMIC ESM operation in level mode set interrupt and reset when pmic esm_in pin is low"
