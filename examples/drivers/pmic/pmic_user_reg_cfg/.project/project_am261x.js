...
function getComponentProperty() {
    ...
    property.description = "An example to show PMIC user space register configurations, set and get verious configurations like gpio, vmon, thermal... "
