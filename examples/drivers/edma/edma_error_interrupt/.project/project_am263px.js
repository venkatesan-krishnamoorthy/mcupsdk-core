...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EDMA_ERROR_INTERRUPT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "edma_error_interrupt",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "edma_error_interrupt";
    property.isInternal = false;
    property.description = "An EDMA Error Interrupt example. This example demonstrates Error interrupts in EDMA.";
