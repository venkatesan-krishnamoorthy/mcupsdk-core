...
function getComponentProperty(device) {
    ...
    property.name = "epwm_synchronization";
    property.isInternal = false;
    property.description = "The purpose of the example is to configure and display synhronization among EPWM's that are phase-shifted"
