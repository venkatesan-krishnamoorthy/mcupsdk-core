...
const readmeDoxygenPageTag = "EXAMPLES_OPTIFLASH_XIP_32K_BENCHMARK";
...
[
    {
        input: ".project/templates/am261x/optiflash_benchmark/ocmc_benchmarking.c.xdt",
        output: "../../../ocmc_benchmarking.c",
        options: template_options
    },
    {
        input: ".project/templates/am261x/optiflash_benchmark/ocmc_benchmarking.h.xdt",
        output: "../../../ocmc_benchmarking.h",
        options: template_options
    },
    {
        input: ".project/templates/am261x/optiflash_benchmark/ocmc_main.c.xdt",
        output: "../main.c",
        options: template_options
    },
    {
        input: ".project/templates/am261x/optiflash_benchmark/annotations.S.xdt",
        output: "../../../annotations.S",
        options: template_options
    },
    {
        input: ".project/templates/am261x/optiflash_benchmark/example.syscfg.xdt",
...
function getComponentProperty() {
    ...
    property.name = "optiflash_xip_benchmark_l2_32k";
