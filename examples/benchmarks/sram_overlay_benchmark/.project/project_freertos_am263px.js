...
const readmeDoxygenPageTag = "EXAMPLES_SRAM_OVERLAY";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "sram_overlay_main",
        },
    }
];
...
const buildOptionCombos = [
    ...
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am263px-lp", os: "freertos", isPartOfSystemProject: false},
];
...
function getComponentProperty() {
    ...
    property.name = "sram_overlay";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "Shows how to use and implement overlay"
